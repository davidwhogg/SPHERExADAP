...
There is work in machine learning that shows that it is both possible and effective to learn flexible models with geometric structure of these types using \emph{invariant scalars} \cite{scalars}.
